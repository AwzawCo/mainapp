...
// Loading temporary static comments in Array
- (void)loadComments {
    ...
    for (int i=0; i<10; i++) {
        ...
        [dict setObject:@"other" forKey:@"comment_by"];
            [dict setObject:TempTextCommentContent forKey:@"comment_desc"];
...
- (IBAction)btnSendClick:(UIButton *)sender {
    ...
    // temporary logic afterwards we will go for Model for this
    NSMutableDictionary *dict = [[NSMutableDictionary alloc]init];
